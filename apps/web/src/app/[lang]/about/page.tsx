export default async function AboutPage() {
  return (
    <section className="rounded-2xl bg-[#f6f2ea] p-6 text-[#0f1230] shadow-lg sm:p-10">
      <div className="grid gap-10 lg:grid-cols-[1.2fr_0.9fr] lg:items-start">
        <div className="space-y-10">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-2xl font-semibold tracking-tight">Designer</p>
              <p className="mt-4 text-lg">Hana Murakami (村上 花)</p>
            </div>
          </div>
          ...
          <div className="space-y-6 text-sm text-[#3b3f58]">
            <div>
              <p className="text-xs font-semibold tracking-[0.2em] text-[#0f1230]">SKILLS</p>
            </div>
          ...
          <div className="space-y-5 text-sm leading-relaxed text-[#3b3f58]">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#0f1230]">PHILOSOPHY</p>
            <p>I want to design architecture as if I were writing a poem.</p>
            <p>
              I would like my design to keep supporting someone for a lifelong time. I want to create architecture
              like gentle words, a beautiful poem that stays in one's mind forever and saves us when needed.
            </p>
            <p>
            ...
            <p className="pt-2 text-[#0f1230]">HANA MURAKAMI</p>
          </div>
        </div>
